    ...
    public function insert($tabela = NULL, $data = NULL, $get_last_id = NULL) {
        ...
        if ($tabela && is_array($data)) {
            ...
            if ($get_last_id) {
                ...
                $this->session->set_userdata('last_id', $this->db->insert_id()); //Se no add estiver TRUE ele recupera o ultimo ID
            }
            ...
            if (!$status) {
                ...
                foreach ($error as $code) {
                    ...
                    if ($code == 1451) {
                        ...
                        $this->session->set_flashdata('error', 'Esse registro não poderá ser excluido, pois está sendo utilizada em outra tabela');
                    }
                }
            } else {
