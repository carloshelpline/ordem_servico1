            ...
            <form class="user" method="POST" name="form_sdd">
                ...
                <div class="form-group row mb-3">
                        ...
                        <div class="col-md-1 mb-3">
                            <label>Número</label>
                            <input type="text" class="form-control form-control-user" name="vendedor_numero_endereco" placeholder="Número" value="<?php echo set_value('vendedor_numero_endereco'); ?>">
