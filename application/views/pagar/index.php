...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <!--- ?php echo date('Y-m-d H:i:s') ?> Mostra a data e hora  -->
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova conta" href="<?php echo base_url('pagar/add'); ?>" class="btn btn-success btn-sm float-right">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pr-4">
                                        ...
                                        if ($conta->conta_pagar_status == 1) {
                                            ...
                                            echo '<span class="badge badge-secondary btn-sm">A paga</span>';
                                        } else if (strtotime($conta->conta_pagar_data_vencimento) == strtotime(date('y-m-d'))) {
                                    ...
                                    <td class="text-right"> <!-- Ajusta os botoes abaixo ao final da pagina -->
                                        <a title="Editar" href="<?php echo base_url('pagar/edit/' . $conta->conta_pagar_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a> <!-- Icone/Botao Editar -->
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#conta-<?php echo $conta->conta_pagar_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a> <!-- Icone/Botao Excluir -->
                                    </td>
                                </tr>
