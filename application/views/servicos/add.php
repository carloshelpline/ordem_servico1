...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('servicos'); ?>">Serviçoes</a></li>
                ...
                <legend class="font-small"><i class="fas fa-laptop-house"></i>&nbsp;Dados do serviço</legend>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-user" name="servico_nome" placeholder="Nome serviço" value="<?php echo set_value('servico_nome'); ?>">
                            <?php echo form_error('servico_nome', '<small class="form-text text-danger">','</small>') ?> <!-- Valida o campo first_name -->
                        </div>
