    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <form class="user" method="POST" name="form_add">
                ...
                <legend class="font-small"><i class="fas fa-laptop-house"></i>&nbsp;Dados do categoria</legend>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <?php echo form_error('categoria_nome', '<small class="form-text text-danger">','</small>') ?> <!-- Valida o campo first_name -->
                        </div>
