            ...
            <form class="user" method="POST" name="form_edit">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        <label>CNPJ</label>
                        <input type="text" class="form-control form-control-user cnpj" name="fornecedor_cnpj" placeholder="Digite CNPJ" value="<?php echo $fornecedor->fornecedor_cnpj; ?>">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control form-control-user" name="fornecedor_ie" placeholder="Digite IE" value="<?php echo $fornecedor->fornecedor_ie; ?>">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        <label>Celular</label>
                        <input type="text" class="form-control form-control-user sp_celphones" name="fornecedor_celular" placeholder="Digite Celular" value="<?php echo $fornecedor->fornecedor_celular; ?>">
                    ...
                    <div class="col-md-4 mb-3">
                        <label>E-mail</label>
                        <input type="email" class="form-control form-control-user" name="fornecedor_email" placeholder="Digite e-mail" value="<?php echo $fornecedor->fornecedor_email; ?>">
                ...
                <fieldset class="mt-4 border p-2">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-1">
                            <label>UF</label>
                            <input type="text" class="form-control form-control-user" name="fornecedor_estado" placeholder="UF" value="<?php echo $fornecedor->fornecedor_estado; ?>">
