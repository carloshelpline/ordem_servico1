                            ...
                            <?php foreach ($contas_receber as $conta): ?>
                                <tr>
                                    ...
                                    <td class="text-right"> <!-- Ajusta os botoes abaixo ao final da pagina -->
                                        <a title="Editar" href="<?php echo base_url('receber/edit/' . $conta->conta_receber_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a> <!-- Icone/Botao Editar -->
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#conta-<?php echo $conta->conta_receber_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a> <!-- Icone/Botao Excluir -->
                                    </td>
                                </tr>
