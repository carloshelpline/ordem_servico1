            ...
            <form class="user" method="POST" name="form_edit">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-3 mb-10">
                        ...
                        <input type="text" class="form-control form-control-user money " name="produto_preco_venda" placeholder="Preço de custo" value="<?php echo $produto->produto_preco_venda; ?>">
                        <?php echo form_error('produto_preco_venda', '<small class="form-text text-danger">','</small>') ?> 
                    </div>
                    
                    <div class="col-md-3 mb-10">
                        <label>Estoque minimo</label>
                        <input type="number" class="form-control form-control-user money " name="produto_estoque_minimo" placeholder="Estoque minimo" value="<?php echo $produto->produto_estoque_minimo; ?>">
                        <?php echo form_error('produto_estoque_minimo', '<small class="form-text text-danger">','</small>') ?> 
                    </div>
                    
                    <div class="col-md-3 mb-10">
                        <label>Quantidade em estoque</label>
                        <input type="number" class="form-control form-control-user money " name="produto_qtde_estoque" placeholder="Quantidade em estoque" value="<?php echo $produto->produto_qtde_estoque; ?>">
