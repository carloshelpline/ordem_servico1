...
//        exit();
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('produto_preco_custo', 'Preco de custo', 'trim|required|max_length[45]');
        $this->form_validation->set_rules('produto_preco_venda', 'Preco de venda', 'trim|required|max_length[45]|callback_check_produto_preco_venda');
        ...
        $this->form_validation->set_rules('produto_obs', '', 'trim|required');
...
//            exit();
    ...
    public function check_produto_preco_venda($produto_preco_venda) {
        ...
        if ($produto_preco_custo > $produto_preco_venda) {
            $this->form_validation->set_message('check_produto_preco_venda', 'Preço de venda deve ser maior ou igual ao preco de custo');
            return FALSE;
        } else {
            return TRUE;
        }
