...
class Usuarios extends CI_Controller {
    ...
    public function index() {
        ...
        //para saber sem esta vindo algo do bd
        // echo '<pre>';
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('confir_password', 'Confirma', 'matches[password]');
        ...
        if (!$usuario_id || !$this->ion_auth->user($usuario_id)->row()) {
            ...
            if ($this->form_validation->run()) {
                ...
                if (!$password) {
                    ...
                    unset($data['password']); //se nao alterar a senha ele recupera a mesma do BD
                }
                ...
                if ($this->ion_auth->update($usuario_id, $data)) {
                    ...
                    /* Se for diferente, atualiza grupo */
    ...
    public function del($usuario_id = NULL) {
        ...
        if (!usuarios_id || !$this->ion_auth->user($usuario_id)->row()) {
            $this->session->set_flashdata('error', 'Usuário não encontrado');
            redirect('usuarios');
        }
