...
/*Array para armazenar temporariamente os serviços adicionados à venda*/
...
/*Bloco que adiciona no array "servicos_adicionados" os servicos já existentes na venda*/
    ...
    $("#buscar_servicos").autocomplete({
        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Serviço não encontrado') {
                ...
                /* a Formula do excel D*(C-(C*E) para o total geral Obs(Se o desconto for 10% será 0,10)  */
                ...
                /*Fim bloco que verifica se o serviço já foi adicionado à venda*/
                /* A função Abaixo setFormula('SUM(F1:F' + i + ')'); vai somando as colulas adicionadas F + i a proxima linha */
